...
@NoArgsConstructor
@AllArgsConstructor
@DynamicInsert //엔티티 저장 시 동적 sql insert 문 생성
@DynamicUpdate //엔티티 저장 시 동적 sql update 문 생성
@Where(clause = "is_deleted=false") //is_deleted가 false인 엔티티만 쿼리에 포, soft delete를 하기 위해서
